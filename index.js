...
//
const A187 = '🔰_*MIMIN X BOT*_🔰'; // JANGAN UBAH-UBAH INFO!!!
const instagram = 'https://instagram.com/mm_'; // JANGAN UBAH-UBAH INFO!!!
const nomer = 'wa.me/628989031500'; // JANGAN UBAH-UBAH INFO!!!
const aktif = 'Tergantung Owner'; // JANGAN UBAH-UBAH INFO!!!
const groupwhatsapp = 'https://chat.whatsapp.com/DhtztPHxL1XLNzr6LYAqmH'; // JANGAN UBAH-UBAH INFO!!!
...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] Power By MIMIN X BOT!`);
});
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @INR21`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @INR21`)
})
...
conn.sendMessage(id, ' _Waalaikumsalam, _Iyaa...ada yang bisa kami bantu? Ketik *!menu* untuk melihat fitur bot kami_ ' ,MessageType.text);
}
else if (text == 'salam'){
conn.sendMessage(id, ' _Waalaikumsalam, _Iyaa...ada yang bisa kami bantu? Ketik *!menu* untuk melihat fitur bot kami_ ' ,MessageType.text);
}
...
conn.sendMessage(id, ' _Iya... aku disini kak... ada yang bisa kami bantu? Ketik *!menu* untuk melihat fitur bot kami_ ' ,MessageType.text);
}
else if (text == 'P'){
conn.sendMessage(id, ' _Iya... aku disini kak... ada yang bisa kami bantu? Ketik *!menu* untuk melihat fitur bot kami_ ' ,MessageType.text);
}
...
conn.sendMessage(id, ' _Pagi juga Kakak... ada yang bisa kami bantu? Ketik *!menu* untuk melihat fitur bot kami_ ' ,MessageType.text);
}
else if (text == 'Siang'){
conn.sendMessage(id, ' _Siang juga Kakak... ada yang bisa kami bantu? Ketik *!menu* untuk melihat fitur bot kami_ ' ,MessageType.text);
}
else if (text == 'Sore'){
conn.sendMessage(id, ' _Sore juga Kakak... ada yang bisa kami bantu? Ketik *!menu* untuk melihat fitur bot kami_ ' ,MessageType.text);
}
else if (text == 'Malam'){
conn.sendMessage(id, ' _Malam juga Kakak... ada yang bisa kami bantu? Ketik *!menu* untuk melihat fitur bot kami_ ' ,MessageType.text);
}
...
conn.sendMessage(id, ' *lu yang bacot_-* ' ,MessageType.text);
}
else if (text == 'Test'){
conn.sendMessage(id, ' _Iya... aku disini kak... ada yang bisa kami bantu? Ketik *!menu* untuk melihat fitur bot kami_ ' ,MessageType.text);
}
...
conn.sendMessage(id, ' _Iya sayang ada apa? ada yang bisa kami bantu? Ketik *!menu* untuk melihat fitur bot kami_ ' ,MessageType.text);
}
...
conn.sendMessage(id, help.help(id, A187, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwhatsapp, youtube) ,MessageType.text);
}
if (text == '!menu'){
var date = new Date();
var tahun = date.getFullYear();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, menu.menu(id, A187, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwhatsapp, youtube) ,MessageType.text);
}
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, donate.donate(id, A187, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwhatsapp, youtube) ,MessageType.text);
}
else if (text == '!donasi'){
var date = new Date();
var tahun = date.getFullYear();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, info.info(id, A187, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwhatsapp, youtube) ,MessageType.text);
}
else if (text == '!foto'){
